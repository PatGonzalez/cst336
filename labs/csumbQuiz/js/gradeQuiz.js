$(document).ready(function(){
    ...
    $("form").submit(function(event) {
        ...
        var answer3 = $("input[name='question3']").val().toLowerCase().trim();
        ...
        // Question 3
        if(answer3 == "miguel lara"){
            correctAnswer($("#question3-feedback"));
        }else{
            incorrectAnswer($("#question3-feedback"));
        }
        
        $("#question3-feedback").append("The answer is <strong>Miguel Lara</strong>");
        ...
        $("#question4-feedback").append("The answer is <strong>Army Base</strong>");
